...
#ifndef FACEDEDUPLIVENESS_SWIFT_H
#define FACEDEDUPLIVENESS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="FacededupLiveness",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSString;
@class NSBundle;
/// Drop-in verification UI: hosts the hosted Facededup flow in a managed <code>WKWebView</code>,
/// grants camera/mic to the page, supplies the demo HTTP Basic password, runs device
/// attestation on request, and reports a typed <code>FacededupResult</code>.
/// \code
...
///
/// \endcode
SWIFT_CLASS("_TtC17FacededupLiveness31FacededupVerificationController")
@interface FacededupVerificationController : UIViewController <WKNavigationDelegate, WKScriptMessageHandler, WKUIDelegate>
